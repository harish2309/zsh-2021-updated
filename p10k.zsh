# Generated by Powerlevel10k configuration wizard on 2020-12-06 at 03:57 IST.
...
# full frame, light-ornaments, sparse, many icons, fluent, transient_prompt,
...
() {
  ...
  # separate prompt from command output. You might want to set 
  ...
  typeset -g POWERLEVEL9K_VCS_COMMIT_ICON='$s'
